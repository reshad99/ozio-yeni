    ...
    public function run(): void
    {
        $countries = [
            [
                ...
                ['code' => 'AG', 'name' => 'Antigua and/or Barbuda', 'phone_code' => '+1-268'],
                ...
                ['code' => 'CD', 'name' => 'Democratic Republic of Congo', 'phone_code' => '+243'],
                ...
                ['code' => 'EC', 'name' => 'Ecudaor', 'phone_code' => '+593'],
                ...
                ['code' => 'FX', 'name' => 'France, Metropolitan', 'phone_code' => '+33'],
                ...
                ['code' => 'GU', 'name' => 'Guam', 'phone_code' => '+1-671'],
                ...
                ['code' => 'HM', 'name' => 'Heard and Mc Donald Islands', 'phone_code' => '+0'],
                ...
                ['code' => 'KP', 'name' => 'Korea, Democratic People\'s Republic of', 'phone_code' => '+850'],
                ['code' => 'KR', 'name' => 'Korea, Republic of', 'phone_code' => '+82'],
                ['code' => 'KW', 'name' => 'Kuwait', 'phone_code' => '+965'],
                ['code' => 'KG', 'name' => 'Kyrgyzstan', 'phone_code' => '+996'],
                ['code' => 'LA', 'name' => 'Lao People\'s Democratic Republic', 'phone_code' => '+856'],
                ...
                ['code' => 'TY', 'name' => 'Mayotte', 'phone_code' => '+262'],
                ...
                ['code' => 'NF', 'name' => 'Norfork Island', 'phone_code' => '+672'],
                ['code' => 'MP', 'name' => 'Northern Mariana Islands', 'phone_code' => '+1-670'],
                ...
                ['code' => 'PN', 'name' => 'Pitcairn', 'phone_code' => '+0'],
                ...
                ['code' => 'SS', 'name' => 'Republic of South Sudan', 'phone_code' => '+211'],
                ...
                ['code' => 'GS', 'name' => 'South Georgia South Sandwich Islands', 'phone_code' => '+0'],
                ['code' => 'ES', 'name' => 'Spain', 'phone_code' => '+34'],
                ['code' => 'LK', 'name' => 'Sri Lanka', 'phone_code' => '+94'],
                ['code' => 'SH', 'name' => 'St. Helena', 'phone_code' => '+290'],
                ['code' => 'PM', 'name' => 'St. Pierre and Miquelon', 'phone_code' => '+508'],
                ['code' => 'SD', 'name' => 'Sudan', 'phone_code' => '+249'],
                ['code' => 'SR', 'name' => 'Suriname', 'phone_code' => '+597'],
                ['code' => 'SJ', 'name' => 'Svalbarn and Jan Mayen Islands', 'phone_code' => '+47'],
                ...
                ['code' => 'TC', 'name' => 'Turks and Caicos Islands', 'phone_code' => '+1-649'],
                ...
                ['code' => 'VA', 'name' => 'Vatican City State', 'phone_code' => '+39'],
                ['code' => 'VE', 'name' => 'Venezuela', 'phone_code' => '+58'],
                ['code' => 'VN', 'name' => 'Vietnam', 'phone_code' => '+84'],
                ['code' => 'VG', 'name' => 'Virgin Islands (British)', 'phone_code' => '+1-284'],
                ['code' => 'VI', 'name' => 'Virgin Islands (U.S.)', 'phone_code' => '+1-340'],
                ...
                ['code' => 'YU', 'name' => 'Yugoslavia', 'phone_code' => '+381'],

                ...
                <div class="mw-lg-600px mx-auto">
                    ...
                    <div class="d-flex">
                        <a href="#" class="btn btn-light w-100">
                            <img alt="Logo"
                                 src="{{ asset('admin/assets/media/svg/social-logos/google.svg') }}"
                                 class="h-15px me-3" />Import Contacts</a>
                        <a href="#" class="btn btn-light w-100 mx-6">
                            <img alt="Logo"
                                 src="{{ asset('admin/assets/media/svg/social-logos/facebook.svg') }}"
                                 class="h-20px me-3" />Facebook</a>
                        <a href="#" class="btn btn-light w-100">
                            <img alt="Logo"
                                 src="{{ asset('admin/assets/media/svg/social-logos/twitter.svg') }}"
                        ...
                        <div data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="text-center px-4">
                                    <img src="{{ asset('admin/assets/media/illustrations/sketchy-1/20.png') }}"

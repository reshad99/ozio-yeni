    ...
    <div class="app-container  container-fluid d-flex align-items-stretch justify-content-between "
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="/metronic8/demo1/../demo1/index.html" class="d-lg-none">
                <img alt="Logo" src="{{ asset('admin/assets/media/logos/gas.png') }}" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ asset('admin/assets/media/avatars/300-6.jpg') }}"
                                                    alt="" />
                                            </div>
                                            <!--end::Symbol-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"
                        ...
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="light">
                                ...
                                <span class="menu-title">
                                    {{ __('admin::general.layout.header.light_mode') }}
                                </span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="dark">
                                ...
                                <span class="menu-title">
                                    {{ __('admin::general.layout.header.dark_mode') }}
                                </span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="system">
                                ...
                                <span class="menu-title">
                                    {{ __('admin::general.layout.header.system') }}
...
{{--                                       {{$user->getEmail()}} </a>--}}
                        ...
                        <div class="menu-item px-5">
                            <a href="/metronic8/demo1/../demo1/account/overview.html" class="menu-link px-5">
                                {{ __('admin::general.layout.header.profile') }}
                            </a>
                        </div>
                        <!--end::Menu item-->

                        ...
                        form, {
                            fields: {
                                name: {
                                    validators: {
                                        notEmpty: {
                                            message: "{{ __('admin::general.pages.department.list.department_region_code') }}"
                                        }
                                    }
                                },
                                region_id: {
                                    validators: {
                                        notEmpty: {
                                            message: "{{ __('admin::general.pages.department.list.department_region_id_is_required') }}"
                                        }
                                    }
                                },
                            },
                        ...
                        if (validator) {
                            validator.validate().then(function(status) {
                                ...
                                if (status == 'Valid') {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "{{ route('admin.ajax.department.create') }}", // Update with your API endpoint
                                        data: formData,
                                        success: function(response) {
                                            ...
                                            submitButton.disabled =
                                                false;
                                            Swal.fire({
                                                text: " {{ __('admin::general.pages.department.list.added_new_department') }}",
                                                icon: "success",

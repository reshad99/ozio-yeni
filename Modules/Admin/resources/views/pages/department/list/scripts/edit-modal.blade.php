    ...
    $(document).ready(function() {
        ...
        var KTModalNewTarget = function() {
            ...
            $(document).on('click', "a[data-bs-target='#kt_modal_new2_target']", async function() {
                ...
                let url =
                    `{{ route('admin.ajax.department.read', ['id' => '-1']) }}`;
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        form.find("select[name='region_id']").val(response.region
                            .id).trigger('change');
                    ...
                    form, {
                        fields: {
                            ...
                            region_code: {
                                validators: {
                                    notEmpty: {
                                        message: "{{ __('admin::general.pages.department.list.department_region_code_is_required') }}"
                                    }
                                }
                            },
                        },
                    ...
                    if (validator) {
                        validator.validate().then(function(status) {
                            ...
                            if (status == 'Valid') {
                                ...
                                let url =
                                    `{{ route('admin.ajax.department.update', ['id' => '-1']) }}`;
                                console.log(url);

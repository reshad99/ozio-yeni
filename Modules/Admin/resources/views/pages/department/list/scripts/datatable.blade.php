            ...
            var initDatatable = function() {
                window.datatable = dt = $("#kt_datatable_example_1").DataTable({
                    ...
                    ajax: function(data, callback, settings) {
                        ...
                        data.with = ['organisation', 'region'];
                        $.ajax({
                            url: "{{ route('admin.ajax.department.datatable') }}", // AJAX isteğinin yapılacağı URL
                            data: data,
                    ...
                    d.addEventListener('click', function(e) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                let url =
                                    `{{ route('admin.ajax.department.delete', ['id' => '-1']) }}`;
                                ...
                                $.ajax({
                                    ...
                                    error: function(xhr) {
                                        Swal.fire({
                                            text: customerName +
                                                "{{ __('admin::general.pages.department.list.department_was_not_deleted') }}" +
                                                xhr
                                                .responseJSON
                                                .message,
                                            icon: "error",

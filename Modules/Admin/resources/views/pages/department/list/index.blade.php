...
@section('content')
                    ...
                    <div class="d-flex flex-stack mb-5">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-docs-table-filter="search" class="form-control  w-250px ps-15"
                                placeholder="{{ __('admin::general.pages.department.list.search_department') }}" />
                        ...
                        @can('create-department')
                            <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    ...
                                    {{ __('admin::general.pages.department.list.add_new_department') }}
                                </button>
                            </div>
                        @endcan
                    ...
                    <table style="border-radius: 10px; overflow: hidden" id="kt_datatable_example_1"
                        ...
                        <thead>
                            <tr class="text-start text-white bg-primary fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th>{{ __('admin::general.pages.department.list.department_name') }}</th>
                                <th>{{ __('admin::general.pages.department.list.organisation_name') }}</th>
                                <th>{{ __('admin::general.pages.department.list.region_name') }}</th>
                                <th>{{ __('admin::general.pages.department.list.date') }}</th>
    ...
    @include('admin::pages.department.list.sections.add-modal')
    @include('admin::pages.department.list.sections.edit-modal')
@endsection
...
@section('scripts')
    ...
    @include('admin::pages.department.list.scripts.datatable')
    @include('admin::pages.department.list.scripts.add-modal')
    @include('admin::pages.department.list.scripts.edit-modal')
    <script>
        ...
        window.loadAjax = async function() {
            if (firstTimeClick) {
                let promise = new Promise(function(resolve, reject) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "{{ route('admin.ajax.region.list') }}", // Update with your API endpoint

<script>
    $(document).ready(function() {
        document.querySelector('[data-bs-target="#kt_modal_new_target"]').addEventListener('click', async function() {
                    ...
                    if (validator) {
                        validator.validate().then(function(status) {
                            ...
                            if (status == 'Valid') {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "{{ route('admin.ajax.transport.car.create') }}", // Update with your API endpoint
                                    data: formData,
                                    success: function(response) {
                                        ...
                                        submitButton.disabled =
                                            false;
                                        Swal.fire({
                                            text: " {{ __('admin::general.pages.transport.car.list.added_new_car') }}",
                                            icon: "success",

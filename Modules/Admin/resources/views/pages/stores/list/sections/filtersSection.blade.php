                ...
                <div class="col-10">
                    <div class="row">
                        ...
                        <div class="col-3 mt-5">
                            ...
                            <input type="text" class="form-control w-170px " id="filter_email"
                        ...
                        <div class="col-3 mt-5">
                            <label for="filter_status">{{ __('admin::general.filters.status') }}</label>
                            <!--begin::Select-->
                            <select class="form-select form-select-solid status-select2" data-control="select2"
                                ...
                                @foreach(\App\Enums\StatusEnum::cases() as $status)
                                    <option
                                        value="{{$status->value}}">{{ __('admin::general.pages.list.' . $status->value) }}</option>
                                @endforeach
                            </select>
                            <!--end::Select-->
                        </div>

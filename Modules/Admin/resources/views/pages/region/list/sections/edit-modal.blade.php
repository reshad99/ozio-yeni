        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-header pb-md-5 border-0 justify-content-end bg-primary">
                ...
                <h2 class="w-100 text-start modal-title text-white">
                    {{ __('admin::general.pages.region.list.add_new_region') }}</h2>
                <!-- Title added here -->
                <!--end::Title-->
                        ...
                        <div class="col-12 col-lg-12">
                            ...
                            <div class="row g-9 mb-8">
                                ...
                                <div class="col-md-6 fv-row">
                                    <label for="name-input" class="required fs-5 fw-semibold mb-2">{{ __('admin::general.pages.region.list.region_name') }}</label>
                                    <input class="form-control " name="name">
                                </div>
                                <div class="col-md-6 fv-row">
                                    <label for="department-select2"
                                        class="required fs-5 fw-semibold mb-2">{{ __('admin::general.pages.region.list.organisation') }}</label>

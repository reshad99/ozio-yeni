                    ...
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            ...
                            <div class="col-md-12 fv-row">
                                <label class=" fs-5 fw-semibold mb-2">{{ __('admin::general.pages.emergencyCall.list.edit_modal.crm_code') }}</label>
                            ...
                            <div class="row border border-2 py-5" style="border-radius: 6px">
                                        ...
                                        <ul class="nav nav-tabs flex-nowrap text-nowrap">
                                            <li class="nav-item active">
                                                <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0 active"
                                                    ...
                                                    href="#kt_tab_pane_3">{{ __('admin::general.pages.emergencyCall.list.edit_modal.subscriber') }}</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0"
                                                    data-bs-toggle="tab" aria-selected="false"
                                                    href="#kt_tab_pane_4">{{ __('admin::general.pages.emergencyCall.list.edit_modal.non_subscriber') }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="kt_tab_pane_3" role="tabpanel">
                                        <div class="row g-9 mb-8">
                                            <div class="col-12">
                                                <a class="w-100 btn btn-primary"
                                                    data-bs-stacked-modal="#kt_modal_select_users">{{ __('admin::general.pages.emergencyCall.list.edit_modal.select_subscriber') }}</a>
                                            </div>
                                        ...
                                        <div class="row g-9 mb-8">
                                            <div class="col-md-4 fv-row">
                                                <label class="required fs-5 fw-semibold mb-2">{{ __('admin::general.pages.emergencyCall.list.edit_modal.fin') }}</label>
                                            ...
                                            <div class="col-md-4 fv-row">
                                                <label class="fs-5 fw-semibold mb-2" for="input_meter_number">{{ __('admin::general.pages.emergencyCall.list.edit_modal.meter_number') }}</label>
                                                <input readonly class="form-control " id="input_meter_number"
                                                    name="subscriber_meter_number">
                                            </div>
                                            <div class="col-md-12 fv-row">
                                                <label class="fs-5 fw-semibold mb-2"
                                                    for="input_passport_number">{{ __('admin::general.pages.emergencyCall.list.edit_modal.passport_number') }}</label>
                                        ...
                                        <div class="row g-9 mb-8">
                                            ...
                                            <div class="col-md-8 fv-row">
                                                <label class="required fs-5 fw-semibold mb-2">{{ __('admin::general.pages.emergencyCall.list.edit_modal.address') }}</label>
                                                <input class="form-control " name="address">
                                            </div>
                                        </div>
                                        <div class="row g-9 mb-8">
                                            <div class="col-md-8 fv-row">
                                                <label class=" fs-5 fw-semibold mb-2">{{ __('admin::general.pages.emergencyCall.list.edit_modal.caller_full_name') }}</label>
                                                <input class="form-control " name="caller_fullname">
                                            </div>
                                            <div class="col-md-4 fv-row">
                                                <label class=" fs-5 fw-semibold mb-2">{{ __('admin::general.pages.emergencyCall.list.edit_modal.caller_phone_number') }}</label>
                                    ...
                                    <div class="tab-pane fade" id="kt_tab_pane_4" role="tabpanel">
                                        ...
                                        <div class="row g-9 mb-8">
                                            ...
                                            <div class="col-md-4 fv-row">
                                                <label class="fs-5 fw-semibold mb-2" for="input_meter_number">{{ __('admin::general.pages.emergencyCall.list.edit_modal.meter_number') }}
                                                    </label>
                                        ...
                                        <div class="row g-9 mb-8">
                                            ...
                                            <div class="col-md-2">
                                                <a class="w-100 btn btn-primary"
                                                    data-bs-stacked-modal="#kt_modal_new_address">{{ __('admin::general.pages.emergencyCall.list.edit_modal.select_address') }}</a>
                                            </div>
                                        </div>

                                        <div class="row g-9 mb-8">
                                            <div class="col-md-8 fv-row">
                                                <label class="required fs-5 fw-semibold mb-2">{{ __('admin::general.pages.emergencyCall.list.edit_modal.orientation') }}</label>
                                                <input class="form-control " name="address">
                                            </div>
                                            <div class="col-md-4 fv-row">
                                                <label

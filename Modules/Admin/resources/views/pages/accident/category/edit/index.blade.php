                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-header">
                            <div class="card-title">
                                <h2>{{ __('admin::general.pages.accident.category.edit.general') }}</h2>
                            </div>
                        </div>
                        <!--end::Card header-->
                        <!--begin::Card body-->
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                <!--begin::Label-->
                                <label
                                    class="required form-label">{{ __('admin::general.pages.accident.category.edit.parent_category_name') }}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <!--begin::Select2-->
                                ...
                                <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                    ...
                                    <option value="0">{{ __('admin::general.pages.accident.category.edit.none') }}
                                    </option>
                                    @foreach ($accidentCategories as $accidentCategory)
                                        @if ($accidentCategory->id != $category->id)
                                            <option value="{{ $accidentCategory->id }}"
                                                @if ($category->parent_id == $accidentCategory->id) selected @endif>
                                                {{ $accidentCategory->name }}</option>
                                        @endif
                                    @endforeach
                                </select>
                                <!--end::Select2-->
                            ...
                            <div class="mb-10 fv-row">
                                <!--begin::Label-->
                                <label
                                    class="required form-label">{{ __('admin::general.pages.accident.category.edit.category_name') }}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                ...
                                <div class="text-muted fs-7">
                                    {{ __('admin::general.pages.accident.category.edit.a_category_name_is_required_and_recommended_to_be_unique') }}
                                </div>
                                <!--end::Description-->
                            </div>
                            <!--end::Input group-->
                            <div class="mb-10 fv-row">
                                <div class="d-flex justify-content-between">
                                    <label
                                        class="required form-label col-11">{{ __('admin::general.pages.accident.category.edit.status') }}
                                    </label>
                                ...
                                <!--begin::Description-->
                                <div class="text-muted fs-7">
                                    {{ __('admin::general.pages.accident.category.edit.set_the_category_status') }}.
                                </div>
                                <!--end::Description-->
                            </div>
                        </div>
...
@section('scripts')
    ...
    <!--end::Javascript-->
    @include('admin::pages.accident.category.edit.scripts.save-category')
@endsection

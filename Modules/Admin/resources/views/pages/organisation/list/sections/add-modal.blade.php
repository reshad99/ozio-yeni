        ...
        <div class="modal-content rounded">
            <div class="modal-header pb-md-5 border-0 justify-content-end bg-primary">
                <h2 class="w-100 text-start modal-title text-white">
                    {{ __('admin::general.pages.organisation.list.add_new_organisation') }}</h2>
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="row g-9 mb-8">
                                ...
                                <div class="col-md-6 fv-row">
                                    <label for="name-input" class="required fs-5 fw-semibold mb-2">{{ __('admin::general.pages.organisation.list.organisation_name') }}</label>
                                    <input id="name-input" class="form-control" name="org_name">
                                </div>
                            </div>

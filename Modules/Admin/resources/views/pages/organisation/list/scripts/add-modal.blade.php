                        ...
                        form, {
                            fields: {
                                name: {
                                    validators: {
                                        notEmpty: {
                                            message: "{{ __('admin::general.pages.organisation.list.name_required') }}"
                                        }
                                    }
                                },
                            },
                        ...
                        if (validator) {
                            validator.validate().then(function(status) {
                                ...
                                if (status == 'Valid') {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "{{ route('admin.ajax.organisation.create') }}", // Update with your API endpoint
                                        data: formData,
                                        success: function(response) {
                                            ...
                                            submitButton.disabled =
                                                false;
                                            Swal.fire({
                                                text: " {{ __('admin::general.pages.organisation.list.added_new_organisation') }}",
                                                icon: "success",

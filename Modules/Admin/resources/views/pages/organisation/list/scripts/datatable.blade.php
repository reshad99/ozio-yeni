            ...
            var initDatatable = function() {
                window.datatable = dt = $("#kt_datatable_example_1").DataTable({
                    ...
                    ajax: function(data, callback, settings) {
                        ...
                        $.ajax({
                            url: "{{ route('admin.ajax.organisation.datatable') }}", // AJAX isteğinin yapılacağı URL
                            data: data,
            ...
            var handleDeleteRows = () => {
                ...
                deleteButtons.forEach(d => {
                    ...
                    d.addEventListener('click', function(e) {
                        ...
                        Swal.fire({
                            text: "{{ __('admin::general.pages.organisation.list.are_you_sure_you_want_to_delete_this') }} " +
                                customerName + "?",
                            icon: "warning",
                            ...
                            if (result.value) {
                                ...
                                let id = parent.querySelectorAll('td')[0]
                                    ...
                                    let url =
                                    `{{ route('admin.ajax.organisation.delete', ['id' => '-1']) }}`;
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        Swal.fire({
                                            text: "" +
                                                customerName +
                                                " {{ __('admin::general.pages.organisation.list.organisation_was_successfully_deleted') }}" +
                                                "!.",
                                            icon: "success",
                                            buttonsStyling: false,
                                    ...
                                    error: function(xhr) {
                                        Swal.fire({
                                            text: customerName +
                                                "{{ __('admin::general.pages.organisation.list.organisation_was_not_deleted') }}" +
                                                xhr
                                                .responseJSON
                                                .message,
                                            icon: "error",
                                ...
                                Swal.fire({
                                    text: customerName +
                                        "{{ __('admin::general.pages.emergencyCall.list.organisation_was_not_deleted') }}",
                                    icon: "error",
                                    buttonsStyling: false,
                                    confirmButtonText: "{{ __('admin::general.shared.got_it') }}",
                                    customClass: {

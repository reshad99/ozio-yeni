    ...
    <div class="auth-wrapper">
        <div class="auth-wrapper-left">
            <div class="auth-left-cont">
                ...
                {{--                <img class="onerror-image"  data-onerror-image="{{asset('//admin/img/favicon.png')}}"--}}
                ...
                <h2 class="title">Your <span class="d-block">All Service</span> <strong class="text--039D55">in one
                        field....</strong></h2>
            </div>
        </div>
            ...
            <div class="auth-wrapper-form">
                ...
                <form class="" action="#" method="post" id="form-id">
                    ...
                    <div class="auth-header">
                        <div class="mb-5">
                            <h2 class="title">'role' signin</h2>
                            <div>welcome_back_login_to_your_panel.</div>
                        </div>
                    </div>

                    <!-- Form Group -->
                    <div class="js-form-message form-group">
                        <label class="input-label text-capitalize" for="signinSrEmail">your_email</label>

                        <input type="email" class="form-control form-control-lg" name="email" id="signinSrEmail"
                               tabindex="1" placeholder="email@address.com" value="{{ $email ?? '' }}"
                               aria-label="email@address.com"
                               required data-msg="Please_enter_a_valid_email_address">
                    </div>
                    <!-- End Form Group -->
                    ...
                    <div class="js-form-message form-group mb-2">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="password" class="js-toggle-password form-control form-control-lg"
                                   ...
                                   aria-label="password_length_placeholder" required
                                   data-msg="invalid_password_warning"
...
{{--                        {{ $role == 'admin' ? '' : 'none' }};--}}
                        ...
                        <!-- End forget password -->
                        <div class="form-group" id="forget-password1" style="
                        {{--display: {{ $role == 'vendor' ? '' : 'none' }};--}}
                        ">
                            <div class="custom-control">
                                <span type="button" data-toggle="modal" class="text-primary"
                                      data-target="#forgetPassModal1">Forget Password?</span>
                            </div>
                        </div>
                        <!-- End forget password -->
                    </div>
                    ...
                    <button type="submit" class="btn btn-lg btn-block btn--primary mt-xxl-3" id="signInBtn">login
                    </button>
                </form>
                <!-- End Form -->
        ...
        <span type="button" class="close-modal-icon" data-dismiss="modal">
            ...
            <div class="modal-body">
                <div class="forget-pass-content">
                    <img src="{{asset('//admin/img/send-mail.svg')}}" alt="">
                    <!-- After Succeed -->
                    <!-- <img src="{{asset('//admin/img/sent-mail.svg')}}" alt=""> -->
                    <h4>
        ...
        <span type="button" class="close-modal-icon" data-dismiss="modal">
            ...
            <div class="modal-body">
                <div class="forget-pass-content">
                    ...
                    <form class=""
                          {{--                          action="{{ route('vendor-reset-password') }}" --}}
                          method="post">
                        @csrf
